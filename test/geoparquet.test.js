...
describe('geoparquet', () => {
  ...
  describe('parseGeoParquet', () => {
    ...
    test('parses the official GeoParquet example', () => {
      // The file is here: https://github.com/opengeospatial/geoparquet/blob/release-v1.1.0.post1/examples/example.parquet
